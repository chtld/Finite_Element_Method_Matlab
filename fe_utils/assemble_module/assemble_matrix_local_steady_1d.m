function A = assemble_matrix(coef_fun,mesh,FE,basis_type_trial,basis_type_test,der_trial,der_test,gauss_type)
    ...
    for j=1: number_of_local_basis
        for i=1:number_of_local_basis
            A(FE.Tb(i,n),FE.Tb(j,n))= A(FE.Tb(i,n),FE.Tb(j,n))...
                +gauss_int_trial_test(coef_fun, vertices, basis_type_trial,basis_type_test,...
